...
let Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el, ['aria-label', 'tabindex', 'title']);
  }
  ...
  render() {
    ...
    const label = (0,_helpers_eed79a2b_js__WEBPACK_IMPORTED_MODULE_3__.k)(this.el);
    ...
    }, this.inheritedAttributes)), this.clearInput && !this.readonly && !this.disabled && (0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      "aria-label": "reset",
      type: "button",
